...
class SingleMovieDetails extends Component {
  ...
  getMovieDetails = async () => {
    ...
    const {params} = match
    const {id} = params
    const getMovieApi = `https://api.themoviedb.org/3/movie/${id}?api_key=f32b79895b21468afbdd6d5342cbf3da&language=en-US`
    const getCastApi = `https://api.themoviedb.org/3/movie/${id}/credits?api_key=f32b79895b21468afbdd6d5342cbf3da&language=en-US`
